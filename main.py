...
sentence = "To the right, in a small parade, there's Neat Burger, knocking out pea protein and corn-based patties, dyed what they think are the right colours by the addition of beetroot and turmeric."
# sentence = "But the word-spaghetti of the menu descriptions – 'aubergine, kalamatas, tahini' reads one; 'grilled beetroot, spring onion, smoked soy' reads another – is so alluring, so well lubricated with promise, that I give myself to it happily."
...
# sentence = "That's exactly what you would expect of a chef like Shaun Moffat, who has cooked in London at the Middle Eastern-inflected Berber & Q, and at the cheerfully iconoclastic Manteca, which treats the Italian classics as a mere opening position in a ribald negotiation."
