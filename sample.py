...
def _generate_samples_csv(probas_df, scores_df):
    ...
    for class_name in class_names:
        ...
        q1_positive_query_df = probas_df[abs(probas_df[f'proba {class_name}'] - q1_score_positive) <= 0.05].sample(n=1)
        ...
        q3_negative_query_df = probas_df[abs(probas_df[f'proba {class_name}'] - q3_score_negative) <= 0.05].sample(n=1)
